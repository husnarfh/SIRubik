...
class JadwalController extends Controller
{
    ...
    public function buatJadwal($id_matkul,$semester){
        ...
        ['semester','=',Auth::user()->semester]])->first()!=null)
            return back()->with('danger', 'Pelajaran sudah ada di jadwal!');
        Jadwal::create([
            'id_mhs' => Auth::user()->id,
            'id_matkul' => $id_matkul,
            'semester' => $semester,
        ...
        return back()->with('success', 'Pelajaran telah ditambahkan');
    }
    //
    public function hapusJadwal($id_jadwal){
        ...
        $jadwal->delete();
        Auth::user()->update(['approve'=>0]);
        return back()->with('success', 'Pelajaran telah dihapus');
    }
}
