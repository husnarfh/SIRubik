        ...
        <div class="col-xs-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                  <li class="active"><a href="#semester_1" data-toggle="tab">Tabel Seluruh Materi Pelajaran</a></li>
                          ...
                          <tbody>
                              ...
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    <br>
                                    <form action="{{route('disapproveJadwal', $mahasiswa->id)}}" method="post">{{csrf_field()}}
                                      <button type="submit" class="btn btn-primary"><i class="fa fa-edit"></i>Ubah Materi</button>
                                    </form>
                                    <br>
                                    <form action="{{route('disapproveJadwal', $mahasiswa->id)}}" method="post">{{csrf_field()}}
